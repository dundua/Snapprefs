...
public final class Common {
	...
	final static String Class_AfterText= Class_CaptionView + "$VanillaCaptionEditText$1";
	final static String Class_Friend= basename + ".model.Friend";
	final static String Class_ScreenshotDetector= basename + ".screenshotdetection.ScreenshotDetector";
